...
const translations = {
    en: {
        ...
        wifi: "Wi-Fi",
        practice: "Practice",
        toggle_midi_mode: "Toggle Mode",
        midi_mode_sidebar_light_show: "Mode: Light show",
        midi_mode_sidebar_learning: "Mode: Learning",
        ...
        load_preset: "Load",
        save_preset_button: "Save",
        save_as_preset: "Save As...",
        rename_preset_button: "Rename",
        delete_preset_button: "Delete",
        import_preset: "Import Preset",
        export_preset: "Export Preset",
        enter_preset_name: "Enter preset name:",
        preset_saved_successfully: "Preset saved successfully",
        preset_error: "Error: ",
        please_select_preset_to_save: "Please select a preset to save to",
        overwrite_preset_confirm: "Overwrite preset '{0}' with current settings?",
        please_select_preset_first: "Please select a preset first",
        load_preset_confirm: "Load preset '{0}'? This will reload LED settings (color modes, light modes, brightness).\n\nNote: This may take 10+ seconds to complete.",
        preset_load_timeout: "Error: Request timed out. The preset may still be loading. Please refresh the page.",
        preset_load_error: "Error loading preset: ",
        delete_preset_confirm: "Delete preset '{0}'?",
        enter_new_preset_name: "Enter new name:",
        preset_uploaded_successfully: "Preset uploaded successfully",
        ...
        midi_events_filter: "Filter",
        midi_events_filter_all: "All devices",
        midi_events_filter_piano: "Piano",
        midi_events_filter_computer: "Computer",
        clear_midi_events: "Clear",
        midi_events_copy_hint: "Select text in the log to copy. Lines are tagged [piano] or [computer].",
        ...
        //idle schedule
        idle_schedule: "Idle Schedule",
        add_schedule: "Add Schedule",
        schedule_enabled: "Enabled",
        schedule_disabled: "Disabled",
        schedule_delete: "Delete",
        schedule_no_schedules: "No schedules configured. IDLE animation will run at any time.",
        schedule_no_days: "No days",
        schedule_form_not_found: "Schedule form elements not found",
        schedule_select_times: "Please select both start and end times",
        schedule_select_weekday: "Please select at least one weekday",
        schedule_overlap_detected: "Schedule overlap detected on",
        schedule_overlaps_with: "overlaps with",
        schedule_save_failed: "Failed to save schedule",
        schedule_network_error: "Network error saving schedule",
        ...
        settings: "Settings",
        practice_app_url: "Practice app URL",
        ...
        piano_port: "Piano Port",
        computer_port: "Computer Port",
        midi_mode: "MIDI Mode",
        light_show: "Light show",
        learning_mode: "Learning",
        light_show_help: "Light show: piano keys light the LEDs. Computer port is ignored.",
        learning_mode_help: "Learning: transparent link between piano and computer. Guide lights (channels 11/12 or velocity 1) drive the LEDs. Notes pass both ways; control changes from the computer can be blocked.",
        suppress_computer_control: "Block control changes from computer to piano",
        suppress_computer_control_help: "In Learning mode, stop control_change messages (reverb, volume, etc.) from reaching the piano. Notes and guide lights still pass through.",
        piano_port_help: "Used for lighting keys in Light show mode, and for playing notes back to the piano in Learning mode.",
        computer_port_help: "RTP MIDI, USB-USB, or Bluetooth peer used with Synthesia and similar apps in Learning mode.",
        select_computer_port: "Select Computer Port",
        input_port_setup: "Input Port Setup",
        piano_port_setup: "Piano Port Setup",
        no_input_port_message: "No input port is currently set. Please select your piano from the list below.",
        no_piano_port_message: "No piano port is currently set. Please select your piano from the list below.",
        port_will_be_set_both: "The selected port will be set as both input port and playback port.",
        select_piano_port: "Select Piano Port",
        loading_ports: "Loading ports...",
        no_ports_available: "No MIDI ports are currently available. Please connect your piano and refresh the page.",
        ...
        backlight_effect: "Backlight Effect",
        backlight_effect_wave: "Wave",
        backlight_effect_min: "Dimmest point",
        backlight_effect_cycles: "Waves",
        led_strips: "LED Strips",
        enable_second_strip: "Enable second strip",
        second_strip_pin: "Pin",
        per_strip_hint: "All settings on this page apply to the selected strip. Only gamma correction and the pin assignments are shared by both strips.",
        enable_second_strip_confirm: "Enabling the second LED strip will restart the visualizer. This may take a moment. Continue?",
        disable_second_strip_confirm: "Disabling the second LED strip will restart the visualizer. This may take a moment. Continue?",
        second_strip_not_active: "Second strip is enabled but failed to start. Check that both strips use different PWM channels (one pin from 12/18, one from 13/19) and see the logs.",
        visualizer_restarting: "Visualizer is restarting. Page will refresh shortly.",
        visualizer_restart_error: "Failed to apply the change. Please try again.",
        ...
        update_stage_starting: "Starting update...",
        update_stage_preparing: "Preparing files...",
        update_stage_pulling: "Downloading latest version...",
        update_stage_installing: "Installing dependencies...",
        update_stage_restarting: "Restarting visualizer...",
        update_complete: "Update complete, reloading...",
        ...
        max_acceptable_delay: "Maximum Allowable Delay",
    ...
    pl: {
        ...
        //presets
        presets: "Presety",
        select_preset: "Wybierz preset",
        load_preset: "Załaduj",
        save_preset_button: "Zapisz",
        save_as_preset: "Zapisz jako...",
        rename_preset_button: "Zmień nazwę",
        delete_preset_button: "Usuń",
        import_preset: "Importuj preset",
        export_preset: "Eksportuj preset",
        enter_preset_name: "Wprowadź nazwę presetu:",
        preset_saved_successfully: "Preset zapisany pomyślnie",
        preset_error: "Błąd: ",
        please_select_preset_to_save: "Proszę wybrać preset do zapisania",
        overwrite_preset_confirm: "Nadpisać preset '{0}' aktualnymi ustawieniami?",
        please_select_preset_first: "Proszę najpierw wybrać preset",
        load_preset_confirm: "Załadować preset '{0}'? Spowoduje to przeładowanie ustawień LED (tryby kolorów, tryby świateł, jasność).\n\nUwaga: Może to zająć 10+ sekund.",
        preset_load_timeout: "Błąd: Przekroczono limit czasu żądania. Preset może nadal się ładować. Proszę odświeżyć stronę.",
        preset_load_error: "Błąd ładowania presetu: ",
        delete_preset_confirm: "Usunąć preset '{0}'?",
        enter_new_preset_name: "Wprowadź nową nazwę:",
        preset_uploaded_successfully: "Preset przesłany pomyślnie",
        ...
        search_songs: "Szukaj utworów...",
        no_songs_found: "Nie znaleziono utworów",
        ...
        edit_sequence: "Edytuj sekwencję",
        color: "Kolor",
        ...
        midi_events_filter: "Filtr",
        midi_events_filter_all: "Wszystkie urządzenia",
        midi_events_filter_piano: "Pianino",
        midi_events_filter_computer: "Komputer",
        clear_midi_events: "Wyczyść",
        midi_events_copy_hint: "Zaznacz tekst w dzienniku, aby skopiować. Linie są oznaczone jako [piano] lub [computer].",
        ...
        //idle schedule
        idle_schedule: "Harmonogram bezczynności",
        add_schedule: "Dodaj harmonogram",
        schedule_enabled: "Włączone",
        schedule_disabled: "Wyłączone",
        schedule_delete: "Usuń",
        schedule_no_schedules: "Brak skonfigurowanych harmonogramów. Animacja IDLE będzie działać w dowolnym czasie.",
        schedule_no_days: "Brak dni",
        schedule_form_not_found: "Nie znaleziono elementów formularza harmonogramu",
        schedule_select_times: "Proszę wybrać zarówno czas rozpoczęcia, jak i zakończenia",
        schedule_select_weekday: "Proszę wybrać co najmniej jeden dzień tygodnia",
        schedule_overlap_detected: "Wykryto nakładanie się harmonogramów w dniu",
        schedule_overlaps_with: "nakłada się z",
        schedule_save_failed: "Nie udało się zapisać harmonogramu",
        schedule_network_error: "Błąd sieci podczas zapisywania harmonogramu",
        schedule_day_mon: "Pon",
        schedule_day_tue: "Wt",
        schedule_day_wed: "Śr",
        schedule_day_thu: "Czw",
        schedule_day_fri: "Pt",
        schedule_day_sat: "Sob",
        schedule_day_sun: "Nie",
        ...
        settings: "Ustawienia",
        practice_app_url: "URL aplikacji ćwiczeń",
        ...
        toggle_midi_mode: "Przełącz tryb",
        midi_mode_sidebar_light_show: "Tryb: Light show",
        midi_mode_sidebar_learning: "Tryb: Nauka",
        piano_port: "Port pianina",
        computer_port: "Port komputera",
        midi_mode: "Tryb MIDI",
        light_show: "Light show",
        learning_mode: "Nauka",
        light_show_help: "Light show: klawisze pianina zapalają LED-y. Port komputera jest ignorowany.",
        learning_mode_help: "Nauka: przezroczyste połączenie pianino ↔ komputer. Podświetlenia (kanały 11/12 lub velocity 1) zapalają LED. Nuty przechodzą w obie strony; control change z komputera można blokować.",
        suppress_computer_control: "Blokuj zmiany sterujące z komputera do pianina",
        suppress_computer_control_help: "W trybie Nauka zatrzymuje komunikaty control_change (pogłos, głośność itd.) przed dotarciem do pianina. Nuty i podświetlenia nadal przechodzą.",
        piano_port_help: "Używany do zapalania klawiszy w trybie Light show oraz odtwarzania nut na pianinie w trybie Nauka.",
        computer_port_help: "RTP MIDI, USB-USB lub Bluetooth używany z Synthesia i podobnymi aplikacjami w trybie Nauka.",
        select_computer_port: "Wybierz port komputera",
        piano_port_setup: "Konfiguracja portu pianina",
        no_piano_port_message: "Brak ustawionego portu pianina. Wybierz pianino z listy poniżej.",
        playback_port: "Port odtwarzania",
        input_port_setup: "Konfiguracja portu wejściowego",
        no_input_port_message: "Brak ustawionego portu wejściowego. Proszę wybrać pianino z listy poniżej.",
        port_will_be_set_both: "Wybrany port zostanie ustawiony jako port wejściowy i port odtwarzania.",
        select_piano_port: "Wybierz port pianina:",
        loading_ports: "Ładowanie portów...",
        no_ports_available: "Brak dostępnych portów MIDI. Proszę podłączyć pianino i odświeżyć stronę.",
        dont_show_again: "Nie pokazuj tego komunikatu ponownie",
        set_port: "Ustaw port",
        cancel: "Anuluj",
        setting_port: "Ustawianie portu...",
        select_port: "Wybierz port...",
        error_loading_ports: "Błąd ładowania portów",
        no_ports: "Brak dostępnych portów",
        ...
        backlight_effect: "Efekt podświetlenia",
        backlight_effect_wave: "Fala",
        backlight_effect_min: "Najciemniejszy punkt",
        backlight_effect_cycles: "Fale",
        led_strips: "Paski LED",
        enable_second_strip: "Włącz drugi pasek",
        second_strip_pin: "Pin",
        per_strip_hint: "Wszystkie ustawienia na tej stronie dotyczą wybranego paska. Tylko korekcja gamma i przypisania pinów są wspólne dla obu pasków.",
        enable_second_strip_confirm: "Włączenie drugiego paska LED zrestartuje wizualizator. Może to chwilę potrwać. Kontynuować?",
        disable_second_strip_confirm: "Wyłączenie drugiego paska LED zrestartuje wizualizator. Może to chwilę potrwać. Kontynuować?",
        second_strip_not_active: "Drugi pasek jest włączony, ale nie udało się go uruchomić. Sprawdź, czy oba paski używają różnych kanałów PWM (jeden pin z 12/18, drugi z 13/19) i zajrzyj do logów.",
        visualizer_restarting: "Wizualizator się restartuje. Strona odświeży się za chwilę.",
        visualizer_restart_error: "Nie udało się zastosować zmiany. Spróbuj ponownie.",
        ...
        update_stage_starting: "Rozpoczynanie aktualizacji...",
        update_stage_preparing: "Przygotowywanie plików...",
        update_stage_pulling: "Pobieranie najnowszej wersji...",
        update_stage_installing: "Instalowanie zależności...",
        update_stage_restarting: "Restartowanie wizualizatora...",
        update_complete: "Aktualizacja zakończona, przeładowywanie...",
        ...
        max_acceptable_delay: "Maksymalne Dozwolone Opóźnienie",
    ...
    fr: {
        ...
        load_preset: "Charger",
        save_preset_button: "Enregistrer",
        save_as_preset: "Enregistrer sous...",
        rename_preset_button: "Renommer",
        delete_preset_button: "Supprimer",
        import_preset: "Importer un préréglage",
        export_preset: "Exporter un préréglage",
        enter_preset_name: "Entrez le nom du préréglage:",
        preset_saved_successfully: "Préréglage enregistré avec succès",
        preset_error: "Erreur: ",
        please_select_preset_to_save: "Veuillez sélectionner un préréglage à enregistrer",
        overwrite_preset_confirm: "Remplacer le préréglage '{0}' par les paramètres actuels?",
        please_select_preset_first: "Veuillez d'abord sélectionner un préréglage",
        load_preset_confirm: "Charger le préréglage '{0}'? Cela rechargera les paramètres LED (modes de couleur, modes d'éclairage, luminosité).\n\nNote: Cela peut prendre 10+ secondes.",
        preset_load_timeout: "Erreur: La requête a expiré. Le préréglage peut encore être en cours de chargement. Veuillez actualiser la page.",
        preset_load_error: "Erreur lors du chargement du préréglage: ",
        delete_preset_confirm: "Supprimer le préréglage '{0}'?",
        enter_new_preset_name: "Entrez le nouveau nom:",
        preset_uploaded_successfully: "Préréglage téléchargé avec succès",
        ...
        midi_events_filter: "Filtre",
        midi_events_filter_all: "Tous les appareils",
        midi_events_filter_piano: "Piano",
        midi_events_filter_computer: "Ordinateur",
        clear_midi_events: "Effacer",
        midi_events_copy_hint: "Sélectionnez le texte dans le journal pour le copier. Les lignes sont marquées [piano] ou [computer].",
        ...
        //idle schedule
        idle_schedule: "Planification d'inactivité",
        add_schedule: "Ajouter un planning",
        schedule_enabled: "Activé",
        schedule_disabled: "Désactivé",
        schedule_delete: "Supprimer",
        schedule_no_schedules: "Aucun planning configuré. L'animation IDLE fonctionnera à tout moment.",
        schedule_no_days: "Aucun jour",
        schedule_form_not_found: "Éléments du formulaire de planning introuvables",
        schedule_select_times: "Veuillez sélectionner les heures de début et de fin",
        schedule_select_weekday: "Veuillez sélectionner au moins un jour de la semaine",
        schedule_overlap_detected: "Chevauchement de planning détecté le",
        schedule_overlaps_with: "chevauche avec",
        schedule_save_failed: "Échec de l'enregistrement du planning",
        schedule_network_error: "Erreur réseau lors de l'enregistrement du planning",
        schedule_day_mon: "Lun",
        schedule_day_tue: "Mar",
        schedule_day_wed: "Mer",
        schedule_day_thu: "Jeu",
        schedule_day_fri: "Ven",
        schedule_day_sat: "Sam",
        schedule_day_sun: "Dim",
        ...
        settings: "Paramètres",
        practice_app_url: "URL de l'application d'entraînement",
        ...
        toggle_midi_mode: "Changer de mode",
        midi_mode_sidebar_light_show: "Mode : Light show",
        midi_mode_sidebar_learning: "Mode : Apprentissage",
        piano_port: "Port piano",
        computer_port: "Port ordinateur",
        midi_mode: "Mode MIDI",
        light_show: "Light show",
        learning_mode: "Apprentissage",
        light_show_help: "Light show : les touches du piano allument les LED. Le port ordinateur est ignoré.",
        learning_mode_help: "Apprentissage : lien transparent piano ↔ ordinateur. Les guides (canaux 11/12 ou velocity 1) pilotent les LED. Les notes passent dans les deux sens ; les control change de l'ordinateur peuvent être bloqués.",
        suppress_computer_control: "Bloquer les control change de l'ordinateur vers le piano",
        suppress_computer_control_help: "En mode Apprentissage, empêche les control_change (réverb, volume, etc.) d'atteindre le piano. Les notes et guides passent toujours.",
        piano_port_help: "Utilisé pour allumer les touches en mode Light show, et pour jouer les notes sur le piano en mode Apprentissage.",
        computer_port_help: "RTP MIDI, USB-USB ou Bluetooth utilisé avec Synthesia et applications similaires en mode Apprentissage.",
        select_computer_port: "Sélectionner le port ordinateur",
        piano_port_setup: "Configuration du port piano",
        no_piano_port_message: "Aucun port piano n'est défini. Veuillez sélectionner votre piano dans la liste ci-dessous.",
        playback_port: "Port de lecture",
        input_port_setup: "Configuration du port d'entrée",
        no_input_port_message: "Aucun port d'entrée n'est actuellement défini. Veuillez sélectionner votre piano dans la liste ci-dessous.",
        port_will_be_set_both: "Le port sélectionné sera défini comme port d'entrée et port de lecture.",
        select_piano_port: "Sélectionner le port du piano:",
        loading_ports: "Chargement des ports...",
        no_ports_available: "Aucun port MIDI n'est actuellement disponible. Veuillez connecter votre piano et actualiser la page.",
        dont_show_again: "Ne plus afficher ce message",
        set_port: "Définir le port",
        cancel: "Annuler",
        setting_port: "Définition du port...",
        select_port: "Sélectionner un port...",
        error_loading_ports: "Erreur lors du chargement des ports",
        no_ports: "Aucun port disponible",
        ...
        max_acceptable_delay: "Délai Maximum Autorisé",
    ...
    de: {
        ...
        load_preset: "Laden",
        save_preset_button: "Speichern",
        save_as_preset: "Speichern unter...",
        rename_preset_button: "Umbenennen",
        delete_preset_button: "Löschen",
        import_preset: "Voreinstellung importieren",
        export_preset: "Voreinstellung exportieren",
        enter_preset_name: "Voreinstellungsname eingeben:",
        preset_saved_successfully: "Voreinstellung erfolgreich gespeichert",
        preset_error: "Fehler: ",
        please_select_preset_to_save: "Bitte wählen Sie eine Voreinstellung zum Speichern aus",
        overwrite_preset_confirm: "Voreinstellung '{0}' mit aktuellen Einstellungen überschreiben?",
        please_select_preset_first: "Bitte wählen Sie zuerst eine Voreinstellung aus",
        load_preset_confirm: "Voreinstellung '{0}' laden? Dies lädt die LED-Einstellungen neu (Farbmodi, Lichtmodi, Helligkeit).\n\nHinweis: Dies kann 10+ Sekunden dauern.",
        preset_load_timeout: "Fehler: Zeitüberschreitung der Anfrage. Die Voreinstellung wird möglicherweise noch geladen. Bitte aktualisieren Sie die Seite.",
        preset_load_error: "Fehler beim Laden der Voreinstellung: ",
        delete_preset_confirm: "Voreinstellung '{0}' löschen?",
        enter_new_preset_name: "Neuen Namen eingeben:",
        preset_uploaded_successfully: "Voreinstellung erfolgreich hochgeladen",
        ...
        midi_events_filter: "Filter",
        midi_events_filter_all: "Alle Geräte",
        midi_events_filter_piano: "Klavier",
        midi_events_filter_computer: "Computer",
        clear_midi_events: "Löschen",
        midi_events_copy_hint: "Text im Protokoll markieren, um zu kopieren. Zeilen sind mit [piano] oder [computer] gekennzeichnet.",
        ...
        //idle schedule
        idle_schedule: "Leerlauf-Zeitplan",
        add_schedule: "Zeitplan hinzufügen",
        schedule_enabled: "Aktiviert",
        schedule_disabled: "Deaktiviert",
        schedule_delete: "Löschen",
        schedule_no_schedules: "Keine Zeitpläne konfiguriert. IDLE-Animation läuft jederzeit.",
        schedule_no_days: "Keine Tage",
        schedule_form_not_found: "Zeitplan-Formularelemente nicht gefunden",
        schedule_select_times: "Bitte wählen Sie sowohl Start- als auch Endzeit",
        schedule_select_weekday: "Bitte wählen Sie mindestens einen Wochentag",
        schedule_overlap_detected: "Zeitplanüberschneidung erkannt am",
        schedule_overlaps_with: "überschneidet sich mit",
        schedule_save_failed: "Zeitplan konnte nicht gespeichert werden",
        schedule_network_error: "Netzwerkfehler beim Speichern des Zeitplans",
        schedule_day_mon: "Mo",
        schedule_day_tue: "Di",
        schedule_day_wed: "Mi",
        schedule_day_thu: "Do",
        ...
        practice_app_url: "URL der Übungs-App",
        ...
        toggle_midi_mode: "Modus umschalten",
        midi_mode_sidebar_light_show: "Modus: Light show",
        midi_mode_sidebar_learning: "Modus: Lernen",
        piano_port: "Klavierport",
        computer_port: "Computerport",
        midi_mode: "MIDI-Modus",
        light_show: "Light show",
        learning_mode: "Lernen",
        light_show_help: "Light show: Klaviertasten steuern die LEDs. Der Computerport wird ignoriert.",
        learning_mode_help: "Lernen: transparente Verbindung Klavier ↔ Computer. Führungslichter (Kanäle 11/12 oder Velocity 1) steuern die LEDs. Noten laufen in beide Richtungen; Control-Changes vom Computer können blockiert werden.",
        suppress_computer_control: "Control-Change vom Computer zum Klavier blockieren",
        suppress_computer_control_help: "Im Lernmodus werden control_change-Nachrichten (Hall, Lautstärke usw.) nicht an das Klavier weitergeleitet. Noten und Führungslichter schon.",
        piano_port_help: "Für LED-Beleuchtung im Light-show-Modus und Wiedergabe auf dem Klavier im Lernmodus.",
        computer_port_help: "RTP MIDI, USB-USB oder Bluetooth für Synthesia und ähnliche Apps im Lernmodus.",
        select_computer_port: "Computerport wählen",
        piano_port_setup: "Klavierport einrichten",
        no_piano_port_message: "Es ist kein Klavierport eingestellt. Bitte wählen Sie Ihr Klavier aus der Liste unten.",
        playback_port: "Wiedergabe Port",
        input_port_setup: "Eingangsport einrichten",
        no_input_port_message: "Es ist derzeit kein Eingangsport eingestellt. Bitte wählen Sie Ihr Klavier aus der Liste unten aus.",
        port_will_be_set_both: "Der ausgewählte Port wird sowohl als Eingangsport als auch als Wiedergabeport eingestellt.",
        select_piano_port: "Klavierport auswählen:",
        loading_ports: "Ports werden geladen...",
        no_ports_available: "Derzeit sind keine MIDI-Ports verfügbar. Bitte schließen Sie Ihr Klavier an und aktualisieren Sie die Seite.",
        dont_show_again: "Diese Meldung nicht mehr anzeigen",
        set_port: "Port festlegen",
        cancel: "Abbrechen",
        setting_port: "Port wird festgelegt...",
        select_port: "Port auswählen...",
        error_loading_ports: "Fehler beim Laden der Ports",
        ...
        mistakes: "Zeitfehler",
        max_acceptable_delay: "Maximale zulässige Verzögerung",
    ...
    es: {
        ...
        load_preset: "Cargar",
        save_preset_button: "Guardar",
        save_as_preset: "Guardar como...",
        rename_preset_button: "Renombrar",
        delete_preset_button: "Eliminar",
        import_preset: "Importar preajuste",
        export_preset: "Exportar preajuste",
        enter_preset_name: "Introduce el nombre del preajuste:",
        preset_saved_successfully: "Preajuste guardado correctamente",
        preset_error: "Error: ",
        please_select_preset_to_save: "Por favor selecciona un preajuste para guardar",
        overwrite_preset_confirm: "¿Sobrescribir el preajuste '{0}' con la configuración actual?",
        please_select_preset_first: "Por favor selecciona primero un preajuste",
        load_preset_confirm: "¿Cargar el preajuste '{0}'? Esto recargará la configuración LED (modos de color, modos de luz, brillo).\n\nNota: Esto puede tardar 10+ segundos.",
        preset_load_timeout: "Error: La solicitud ha expirado. El preajuste puede seguir cargándose. Por favor actualiza la página.",
        preset_load_error: "Error al cargar el preajuste: ",
        delete_preset_confirm: "¿Eliminar el preajuste '{0}'?",
        enter_new_preset_name: "Introduce el nuevo nombre:",
        preset_uploaded_successfully: "Preajuste subido correctamente",
        ...
        midi_events_filter: "Filtro",
        midi_events_filter_all: "Todos los dispositivos",
        midi_events_filter_piano: "Piano",
        midi_events_filter_computer: "Ordenador",
        clear_midi_events: "Borrar",
        midi_events_copy_hint: "Selecciona texto en el registro para copiarlo. Las líneas están etiquetadas como [piano] o [computer].",
        ...
        //idle schedule
        idle_schedule: "Horario de inactividad",
        add_schedule: "Agregar horario",
        schedule_enabled: "Habilitado",
        schedule_disabled: "Deshabilitado",
        schedule_delete: "Eliminar",
        schedule_no_schedules: "No hay horarios configurados. La animación IDLE se ejecutará en cualquier momento.",
        schedule_no_days: "Sin días",
        schedule_form_not_found: "Elementos del formulario de horario no encontrados",
        schedule_select_times: "Por favor seleccione tanto la hora de inicio como la de fin",
        schedule_select_weekday: "Por favor seleccione al menos un día de la semana",
        schedule_overlap_detected: "Superposición de horario detectada el",
        schedule_overlaps_with: "se superpone con",
        schedule_save_failed: "Error al guardar el horario",
        schedule_network_error: "Error de red al guardar el horario",
        schedule_day_mon: "Lun",
        schedule_day_tue: "Mar",
        schedule_day_wed: "Mié",
        schedule_day_thu: "Jue",
        schedule_day_fri: "Vie",
        schedule_day_sat: "Sáb",
        schedule_day_sun: "Dom",
        ...
        practice_app_url: "URL de la app de práctica",
        ...
        toggle_midi_mode: "Cambiar modo",
        midi_mode_sidebar_light_show: "Modo: Light show",
        midi_mode_sidebar_learning: "Modo: Aprendizaje",
        piano_port: "Puerto del piano",
        computer_port: "Puerto del ordenador",
        midi_mode: "Modo MIDI",
        light_show: "Light show",
        learning_mode: "Aprendizaje",
        light_show_help: "Light show: las teclas del piano encienden los LEDs. El puerto del ordenador se ignora.",
        learning_mode_help: "Aprendizaje: enlace transparente piano ↔ ordenador. Las guías (canales 11/12 o velocity 1) encienden los LED. Las notas pasan en ambos sentidos; los control changes del ordenador se pueden bloquear.",
        suppress_computer_control: "Bloquear control changes del ordenador al piano",
        suppress_computer_control_help: "En Aprendizaje, detiene los control_change (reverb, volumen, etc.) antes de que lleguen al piano. Las notas y guías sí pasan.",
        piano_port_help: "Se usa para iluminar teclas en Light show y reproducir notas en el piano en Aprendizaje.",
        computer_port_help: "RTP MIDI, USB-USB o Bluetooth para Synthesia y apps similares en Aprendizaje.",
        select_computer_port: "Seleccionar puerto del ordenador",
        piano_port_setup: "Configuración del puerto del piano",
        no_piano_port_message: "No hay puerto de piano configurado. Seleccione su piano de la lista.",
        playback_port: "Puerto de reproducción",
        input_port_setup: "Configuración del puerto de entrada",
        no_input_port_message: "No hay ningún puerto de entrada configurado actualmente. Por favor, seleccione su piano de la lista a continuación.",
        port_will_be_set_both: "El puerto seleccionado se establecerá como puerto de entrada y puerto de reproducción.",
        select_piano_port: "Seleccionar puerto del piano:",
        loading_ports: "Cargando puertos...",
        no_ports_available: "No hay puertos MIDI disponibles actualmente. Por favor, conecte su piano y actualice la página.",
        dont_show_again: "No mostrar este mensaje nuevamente",
        set_port: "Establecer puerto",
        cancel: "Cancelar",
        setting_port: "Estableciendo puerto...",
        select_port: "Seleccionar un puerto...",
        error_loading_ports: "Error al cargar puertos",
        no_ports: "No hay puertos disponibles",
        ...
        max_acceptable_delay: "Retraso Máximo Permitido",
    ...
    zh: {
        ...
        select_preset: "选择预设",
        load_preset: "加载",
        save_preset_button: "保存",
        save_as_preset: "另存为...",
        rename_preset_button: "重命名",
        delete_preset_button: "删除",
        import_preset: "导入预设",
        export_preset: "导出预设",
        enter_preset_name: "输入预设名称:",
        preset_saved_successfully: "预设保存成功",
        preset_error: "错误: ",
        please_select_preset_to_save: "请选择要保存的预设",
        overwrite_preset_confirm: "是否用当前设置覆盖预设 '{0}'?",
        please_select_preset_first: "请先选择预设",
        load_preset_confirm: "是否加载预设 '{0}'? 这将重新加载LED设置（颜色模式、灯光模式、亮度）。\n\n注意：这可能需要10秒以上。",
        preset_load_timeout: "错误：请求超时。预设可能仍在加载中。请刷新页面。",
        preset_load_error: "加载预设时出错: ",
        delete_preset_confirm: "是否删除预设 '{0}'?",
        enter_new_preset_name: "输入新名称:",
        preset_uploaded_successfully: "预设上传成功",
        ...
        midi_events_filter: "筛选",
        midi_events_filter_all: "所有设备",
        midi_events_filter_piano: "钢琴",
        midi_events_filter_computer: "电脑",
        clear_midi_events: "清除",
        midi_events_copy_hint: "在日志中选择文本即可复制。行会标记为 [piano] 或 [computer]。",
        ...
        idle_schedule: "空闲时间表",
        add_schedule: "添加时间表",
        schedule_enabled: "已启用",
        schedule_disabled: "已禁用",
        schedule_delete: "删除",
        schedule_no_schedules: "未配置时间表。空闲动画将随时运行。",
        schedule_no_days: "无日期",
        schedule_form_not_found: "未找到时间表表单元素",
        schedule_select_times: "请选择开始和结束时间",
        schedule_select_weekday: "请至少选择一个工作日",
        schedule_overlap_detected: "检测到时间表重叠于",
        schedule_overlaps_with: "与重叠",
        schedule_save_failed: "保存时间表失败",
        schedule_network_error: "保存时间表时网络错误",
        schedule_day_mon: "周一",
        schedule_day_tue: "周二",
        schedule_day_wed: "周三",
        schedule_day_thu: "周四",
        ...
        input_port: "输入端口",
        toggle_midi_mode: "切换模式",
        midi_mode_sidebar_light_show: "模式: 灯光秀",
        midi_mode_sidebar_learning: "模式: 学习",
        piano_port: "钢琴端口",
        computer_port: "电脑端口",
        midi_mode: "MIDI 模式",
        light_show: "灯光秀",
        learning_mode: "学习",
        light_show_help: "灯光秀：钢琴按键点亮 LED。忽略电脑端口。",
        learning_mode_help: "学习：钢琴与电脑之间的透明连接。引导灯（通道 11/12 或力度 1）驱动 LED。音符双向传递；可阻止电脑发往钢琴的控制变化。",
        suppress_computer_control: "阻止电脑发往钢琴的控制变化",
        suppress_computer_control_help: "学习模式下阻止 control_change（混响、音量等）到达钢琴。音符和引导灯仍会通过。",
        piano_port_help: "灯光秀模式下用于点亮按键，学习模式下用于在钢琴上播放音符。",
        computer_port_help: "学习模式下用于 Synthesia 等应用的 RTP MIDI、USB-USB 或蓝牙设备。",
        select_computer_port: "选择电脑端口",
        piano_port_setup: "钢琴端口设置",
        no_piano_port_message: "当前未设置钢琴端口。请从下面的列表中选择您的钢琴。",
        playback_port: "播放端口",
    ...
    hi: {
        ...
        load_preset: "लोड करें",
        save_preset_button: "सहेजें",
        save_as_preset: "इस रूप में सहेजें...",
        rename_preset_button: "नाम बदलें",
        delete_preset_button: "हटाएं",
        import_preset: "प्रीसेट आयात करें",
        export_preset: "प्रीसेट निर्यात करें",
        enter_preset_name: "प्रीसेट नाम दर्ज करें:",
        preset_saved_successfully: "प्रीसेट सफलतापूर्वक सहेजा गया",
        preset_error: "त्रुटि: ",
        please_select_preset_to_save: "कृपया सहेजने के लिए एक प्रीसेट चुनें",
        overwrite_preset_confirm: "वर्तमान सेटिंग्स के साथ प्रीसेट '{0}' को अधिलेखित करें?",
        please_select_preset_first: "कृपया पहले एक प्रीसेट चुनें",
        load_preset_confirm: "प्रीसेट '{0}' लोड करें? यह LED सेटिंग्स (रंग मोड, प्रकाश मोड, चमक) को पुनः लोड करेगा।\n\nनोट: इसमें 10+ सेकंड लग सकते हैं।",
        preset_load_timeout: "त्रुटि: अनुरोध समय समाप्त हो गया। प्रीसेट अभी भी लोड हो रहा हो सकता है। कृपया पृष्ठ को रीफ्रेश करें।",
        preset_load_error: "प्रीसेट लोड करने में त्रुटि: ",
        delete_preset_confirm: "प्रीसेट '{0}' हटाएं?",
        enter_new_preset_name: "नया नाम दर्ज करें:",
        preset_uploaded_successfully: "प्रीसेट सफलतापूर्वक अपलोड किया गया",
        ...
        edit_sequence: "अनुक्रम संपादित करें",
        color: "रंग",
        next_step: "अगला कदम",
        ...
        midi_events_filter: "फ़िल्टर",
        midi_events_filter_all: "सभी डिवाइस",
        midi_events_filter_piano: "पियानो",
        midi_events_filter_computer: "कंप्यूटर",
        clear_midi_events: "साफ़ करें",
        midi_events_copy_hint: "कॉपी करने के लिए लॉग में टेक्स्ट चुनें। पंक्तियाँ [piano] या [computer] से चिह्नित होती हैं।",
        ...
        //idle schedule
        idle_schedule: "निष्क्रिय अनुसूची",
        add_schedule: "अनुसूची जोड़ें",
        schedule_enabled: "सक्षम",
        schedule_disabled: "अक्षम",
        schedule_delete: "हटाएं",
        schedule_no_schedules: "कोई अनुसूची कॉन्फ़िगर नहीं की गई। आईडल एनिमेशन किसी भी समय चलेगा।",
        schedule_no_days: "कोई दिन नहीं",
        schedule_form_not_found: "अनुसूची फॉर्म तत्व नहीं मिले",
        schedule_select_times: "कृपया प्रारंभ और समाप्ति समय दोनों चुनें",
        schedule_select_weekday: "कृपया कम से कम एक सप्ताह का दिन चुनें",
        schedule_overlap_detected: "अनुसूची ओवरलैप का पता चला",
        schedule_overlaps_with: "के साथ ओवरलैप होता है",
        schedule_save_failed: "अनुसूची सहेजने में विफल",
        schedule_network_error: "अनुसूची सहेजते समय नेटवर्क त्रुटि",
        schedule_day_mon: "सोम",
        schedule_day_tue: "मंगल",
        schedule_day_wed: "बुध",
        schedule_day_thu: "गुरु",
        schedule_day_fri: "शुक्र",
        schedule_day_sat: "शनि",
        schedule_day_sun: "रवि",
        ...
        settings: "सेटिंग्स",
        practice_app_url: "अभ्यास ऐप URL",
        ...
        toggle_midi_mode: "मोड बदलें",
        midi_mode_sidebar_light_show: "मोड: लाइट शो",
        midi_mode_sidebar_learning: "मोड: लर्निंग",
        piano_port: "पियानो पोर्ट",
        computer_port: "कंप्यूटर पोर्ट",
        midi_mode: "MIDI मोड",
        light_show: "लाइट शो",
        learning_mode: "लर्निंग",
        light_show_help: "लाइट शो: पियानो कीज़ LED जलाती हैं। कंप्यूटर पोर्ट अनदेखा होता है।",
        learning_mode_help: "लर्निंग: पियानो ↔ कंप्यूटर का पारदर्शी लिंक। गाइड लाइट्स (चैनल 11/12 या velocity 1) LED जलाती हैं। नोट्स दोनों ओर जाते हैं; कंप्यूटर के control change ब्लॉक किए जा सकते हैं।",
        suppress_computer_control: "कंप्यूटर से पियानो के control change ब्लॉक करें",
        suppress_computer_control_help: "लर्निंग मोड में control_change (रेवर्ब, वॉल्यूम आदि) पियानो तक नहीं जाते। नोट्स और गाइड लाइट्स जाते रहते हैं।",
        piano_port_help: "लाइट शो में कीज़ जलाने और लर्निंग में पियानो पर नोट्स बजाने के लिए।",
        computer_port_help: "लर्निंग मोड में Synthesia आदि के लिए RTP MIDI, USB-USB या Bluetooth।",
        select_computer_port: "कंप्यूटर पोर्ट चुनें",
        piano_port_setup: "पियानो पोर्ट सेटअप",
        no_piano_port_message: "वर्तमान में कोई पियानो पोर्ट सेट नहीं है। कृपया सूची से अपना पियानो चुनें।",
        playback_port: "प्लेबैक पोर्ट",
        input_port_setup: "इनपुट पोर्ट सेटअप",
        no_input_port_message: "वर्तमान में कोई इनपुट पोर्ट सेट नहीं है। कृपया नीचे दी गई सूची से अपना पियानो चुनें।",
        port_will_be_set_both: "चयनित पोर्ट को इनपुट पोर्ट और प्लेबैक पोर्ट दोनों के रूप में सेट किया जाएगा।",
        select_piano_port: "पियानो पोर्ट चुनें:",
        loading_ports: "पोर्ट लोड हो रहे हैं...",
        no_ports_available: "वर्तमान में कोई MIDI पोर्ट उपलब्ध नहीं है। कृपया अपना पियानो कनेक्ट करें और पृष्ठ को रीफ्रेश करें।",
        dont_show_again: "इस संदेश को फिर से न दिखाएं",
        set_port: "पोर्ट सेट करें",
        cancel: "रद्द करें",
        setting_port: "पोर्ट सेट किया जा रहा है...",
        select_port: "एक पोर्ट चुनें...",
        error_loading_ports: "पोर्ट लोड करने में त्रुटि",
        no_ports: "कोई पोर्ट उपलब्ध नहीं",
        ...
        mistakes: "समय त्रुटि",
        max_acceptable_delay: "अधिकतम अनुमेय देरी",
        time: "MIDI समय (सेकंड)",
        delay: "देरी (सेकंड)",
    ...
    pt: {
        ...
        save_preset_button: "Salvar",
        save_as_preset: "Salvar como...",
        rename_preset_button: "Renomear",
        delete_preset_button: "Excluir",
        import_preset: "Importar predefinição",
        export_preset: "Exportar predefinição",
        enter_preset_name: "Digite o nome da predefinição:",
        preset_saved_successfully: "Predefinição salva com sucesso",
        preset_error: "Erro: ",
        please_select_preset_to_save: "Por favor selecione uma predefinição para salvar",
        overwrite_preset_confirm: "Substituir a predefinição '{0}' com as configurações atuais?",
        please_select_preset_first: "Por favor selecione primeiro uma predefinição",
        load_preset_confirm: "Carregar a predefinição '{0}'? Isso recarregará as configurações LED (modos de cor, modos de luz, brilho).\n\nNota: Isso pode levar 10+ segundos.",
        preset_load_timeout: "Erro: Solicitação expirou. A predefinição ainda pode estar carregando. Por favor atualize a página.",
        preset_load_error: "Erro ao carregar a predefinição: ",
        delete_preset_confirm: "Excluir a predefinição '{0}'?",
        enter_new_preset_name: "Digite o novo nome:",
        preset_uploaded_successfully: "Predefinição enviada com sucesso",
        ...
        search_songs: "Pesquisar canções...",
        no_songs_found: "Nenhuma canção encontrada",
        ...
        midi_events_filter: "Filtro",
        midi_events_filter_all: "Todos os dispositivos",
        midi_events_filter_piano: "Piano",
        midi_events_filter_computer: "Computador",
        clear_midi_events: "Limpar",
        midi_events_copy_hint: "Selecione o texto no registo para copiar. As linhas estão marcadas com [piano] ou [computer].",
        ...
        //idle schedule
        idle_schedule: "Agenda de inatividade",
        add_schedule: "Adicionar agenda",
        schedule_enabled: "Habilitado",
        schedule_disabled: "Desabilitado",
        schedule_delete: "Excluir",
        schedule_no_schedules: "Nenhuma agenda configurada. A animação IDLE será executada a qualquer momento.",
        schedule_no_days: "Sem dias",
        schedule_form_not_found: "Elementos do formulário de agenda não encontrados",
        schedule_select_times: "Por favor, selecione os horários de início e fim",
        schedule_select_weekday: "Por favor, selecione pelo menos um dia da semana",
        schedule_overlap_detected: "Sobreposição de agenda detectada em",
        schedule_overlaps_with: "sobrepõe com",
        schedule_save_failed: "Falha ao salvar a agenda",
        schedule_network_error: "Erro de rede ao salvar a agenda",
        schedule_day_mon: "Seg",
        schedule_day_tue: "Ter",
        schedule_day_wed: "Qua",
        schedule_day_thu: "Qui",
        schedule_day_fri: "Sex",
        schedule_day_sat: "Sáb",
        schedule_day_sun: "Dom",
        ...
        practice_app_url: "URL do app de prática",
        ...
        toggle_midi_mode: "Alternar modo",
        midi_mode_sidebar_light_show: "Modo: Light show",
        midi_mode_sidebar_learning: "Modo: Aprendizado",
        piano_port: "Porta do piano",
        computer_port: "Porta do computador",
        midi_mode: "Modo MIDI",
        light_show: "Light show",
        learning_mode: "Aprendizado",
        light_show_help: "Light show: as teclas do piano acendem os LEDs. A porta do computador é ignorada.",
        learning_mode_help: "Aprendizado: ligação transparente piano ↔ computador. Luzes-guia (canais 11/12 ou velocity 1) acendem os LEDs. Notas passam nos dois sentidos; control changes do computador podem ser bloqueados.",
        suppress_computer_control: "Bloquear control changes do computador para o piano",
        suppress_computer_control_help: "No Aprendizado, impede control_change (reverb, volume, etc.) de chegar ao piano. Notas e guias ainda passam.",
        piano_port_help: "Usada para acender teclas no Light show e tocar notas no piano no Aprendizado.",
        computer_port_help: "RTP MIDI, USB-USB ou Bluetooth para Synthesia e apps semelhantes no Aprendizado.",
        select_computer_port: "Selecionar porta do computador",
        piano_port_setup: "Configuração da porta do piano",
        no_piano_port_message: "Nenhuma porta de piano está configurada. Selecione seu piano na lista.",
        playback_port: "Porta de reprodução",
        input_port_setup: "Configuração da porta de entrada",
        no_input_port_message: "Nenhuma porta de entrada está configurada atualmente. Por favor, selecione seu piano na lista abaixo.",
        port_will_be_set_both: "A porta selecionada será definida como porta de entrada e porta de reprodução.",
        select_piano_port: "Selecionar porta do piano:",
        loading_ports: "Carregando portas...",
        no_ports_available: "Nenhuma porta MIDI está disponível no momento. Por favor, conecte seu piano e atualize a página.",
        dont_show_again: "Não mostrar esta mensagem novamente",
        set_port: "Definir porta",
        cancel: "Cancelar",
        setting_port: "Definindo porta...",
        select_port: "Selecionar uma porta...",
        error_loading_ports: "Erro ao carregar portas",
        no_ports: "Nenhuma porta disponível",
        ...
        max_acceptable_delay: "Atraso Máximo Permitido",
    ...
    ja: {
        ...
        load_preset: "読み込む",
        save_preset_button: "保存",
        save_as_preset: "名前を付けて保存...",
        rename_preset_button: "名前を変更",
        delete_preset_button: "削除",
        import_preset: "プリセットをインポート",
        export_preset: "プリセットをエクスポート",
        enter_preset_name: "プリセット名を入力:",
        preset_saved_successfully: "プリセットが正常に保存されました",
        preset_error: "エラー: ",
        please_select_preset_to_save: "保存するプリセットを選択してください",
        overwrite_preset_confirm: "現在の設定でプリセット '{0}' を上書きしますか?",
        please_select_preset_first: "まずプリセットを選択してください",
        load_preset_confirm: "プリセット '{0}' を読み込みますか? これによりLED設定（カラーモード、ライトモード、明るさ）が再読み込みされます。\n\n注意: これには10秒以上かかる場合があります。",
        preset_load_timeout: "エラー: リクエストがタイムアウトしました。プリセットはまだ読み込み中かもしれません。ページを更新してください。",
        preset_load_error: "プリセットの読み込みエラー: ",
        delete_preset_confirm: "プリセット '{0}' を削除しますか?",
        enter_new_preset_name: "新しい名前を入力:",
        preset_uploaded_successfully: "プリセットが正常にアップロードされました",
        ...
        midi_events_filter: "フィルター",
        midi_events_filter_all: "すべてのデバイス",
        midi_events_filter_piano: "ピアノ",
        midi_events_filter_computer: "コンピュータ",
        clear_midi_events: "クリア",
        midi_events_copy_hint: "ログ内のテキストを選択してコピーできます。行には [piano] または [computer] のタグが付きます。",
        ...
        //idle schedule
        idle_schedule: "アイドルスケジュール",
        add_schedule: "スケジュールを追加",
        schedule_enabled: "有効",
        schedule_disabled: "無効",
        schedule_delete: "削除",
        schedule_no_schedules: "スケジュールが設定されていません。IDLEアニメーションはいつでも実行されます。",
        schedule_no_days: "日付なし",
        schedule_form_not_found: "スケジュールフォーム要素が見つかりません",
        schedule_select_times: "開始時刻と終了時刻の両方を選択してください",
        schedule_select_weekday: "少なくとも1つの曜日を選択してください",
        schedule_overlap_detected: "スケジュールの重複が検出されました",
        schedule_overlaps_with: "と重複しています",
        schedule_save_failed: "スケジュールの保存に失敗しました",
        schedule_network_error: "スケジュール保存中のネットワークエラー",
        schedule_day_mon: "月",
        schedule_day_tue: "火",
        schedule_day_wed: "水",
        schedule_day_thu: "木",
        ...
        input_port: "入力ポート",
        toggle_midi_mode: "モード切替",
        midi_mode_sidebar_light_show: "モード: ライトショー",
        midi_mode_sidebar_learning: "モード: ラーニング",
        piano_port: "ピアノポート",
        computer_port: "コンピュータポート",
        midi_mode: "MIDIモード",
        light_show: "ライトショー",
        learning_mode: "ラーニング",
        light_show_help: "ライトショー: ピアノの鍵盤でLEDを点灯。コンピュータポートは無視されます。",
        learning_mode_help: "ラーニング: ピアノとコンピュータの透過リンク。ガイドライト（チャンネル11/12またはvelocity 1）がLEDを点灯。ノートは双方向、コンピュータからのコントロールチェンジはブロック可能。",
        suppress_computer_control: "コンピュータからピアノへのコントロールチェンジをブロック",
        suppress_computer_control_help: "ラーニングモードで control_change（リバーブ、音量など）をピアノに送りません。ノートとガイドライトは通過します。",
        piano_port_help: "ライトショーでの点灯と、ラーニングでのピアノ再生に使用します。",
        computer_port_help: "ラーニングモードでSynthesia等に使うRTP MIDI、USB-USB、Bluetooth。",
        select_computer_port: "コンピュータポートを選択",
        piano_port_setup: "ピアノポート設定",
        no_piano_port_message: "ピアノポートが設定されていません。リストからピアノを選択してください。",
        playback_port: "再生ポート",
        input_port_setup: "入力ポート設定",
        no_input_port_message: "現在、入力ポートが設定されていません。以下のリストからピアノを選択してください。",
        port_will_be_set_both: "選択したポートは、入力ポートと再生ポートの両方として設定されます。",
        select_piano_port: "ピアノポートを選択：",
        loading_ports: "ポートを読み込み中...",
        no_ports_available: "現在、MIDIポートが利用できません。ピアノを接続してページを更新してください。",
        dont_show_again: "このメッセージを再表示しない",
        set_port: "ポートを設定",
        cancel: "キャンセル",
        setting_port: "ポートを設定中...",
        select_port: "ポートを選択...",
        error_loading_ports: "ポートの読み込みエラー",
        no_ports: "利用可能なポートがありません",
        cover_state: "カバーステート",
        screen: "スクリーン",
        lcd_type: "LCDタイプ",
    ...
    load_preset: "로드",
    save_preset_button: "저장",
    save_as_preset: "다른 이름으로 저장...",
    rename_preset_button: "이름 변경",
    delete_preset_button: "삭제",
    import_preset: "프리셋 가져오기",
    export_preset: "프리셋 내보내기",
    enter_preset_name: "프리셋 이름 입력:",
    preset_saved_successfully: "프리셋이 성공적으로 저장되었습니다",
    preset_error: "오류: ",
    please_select_preset_to_save: "저장할 프리셋을 선택하세요",
    overwrite_preset_confirm: "현재 설정으로 프리셋 '{0}'을(를) 덮어쓰시겠습니까?",
    please_select_preset_first: "먼저 프리셋을 선택하세요",
    load_preset_confirm: "프리셋 '{0}'을(를) 로드하시겠습니까? LED 설정(색상 모드, 조명 모드, 밝기)이 다시 로드됩니다.\n\n참고: 10초 이상 걸릴 수 있습니다.",
    preset_load_timeout: "오류: 요청 시간이 초과되었습니다. 프리셋이 아직 로드 중일 수 있습니다. 페이지를 새로고침하세요.",
    preset_load_error: "프리셋 로드 오류: ",
    delete_preset_confirm: "프리셋 '{0}'을(를) 삭제하시겠습니까?",
    enter_new_preset_name: "새 이름 입력:",
    preset_uploaded_successfully: "프리셋이 성공적으로 업로드되었습니다",
    ...
    midi_events_filter: "필터",
    midi_events_filter_all: "모든 장치",
    midi_events_filter_piano: "피아노",
    midi_events_filter_computer: "컴퓨터",
    clear_midi_events: "지우기",
    midi_events_copy_hint: "로그에서 텍스트를 선택하여 복사하세요. 줄에는 [piano] 또는 [computer] 태그가 표시됩니다.",
    ...
    idle_schedule: "유휴 일정",
    add_schedule: "일정 추가",
    schedule_enabled: "활성화됨",
    schedule_disabled: "비활성화됨",
    schedule_delete: "삭제",
    schedule_no_schedules: "일정이 구성되지 않았습니다. IDLE 애니메이션이 언제든지 실행됩니다.",
    schedule_no_days: "날짜 없음",
    schedule_form_not_found: "일정 양식 요소를 찾을 수 없습니다",
    schedule_select_times: "시작 시간과 종료 시간을 모두 선택하세요",
    schedule_select_weekday: "최소한 하나의 요일을 선택하세요",
    schedule_overlap_detected: "일정 중복이 감지되었습니다",
    schedule_overlaps_with: "와 중복됩니다",
    schedule_save_failed: "일정 저장 실패",
    schedule_network_error: "일정 저장 중 네트워크 오류",
    schedule_day_mon: "월",
    schedule_day_tue: "화",
    schedule_day_wed: "수",
    schedule_day_thu: "목",
    ...
    backlight_brightness: "백라이트 밝기",
        input_port: "입력 포트",
        toggle_midi_mode: "모드 전환",
        midi_mode_sidebar_light_show: "모드: 라이트 쇼",
        midi_mode_sidebar_learning: "모드: 러닝",
        piano_port: "피아노 포트",
        computer_port: "컴퓨터 포트",
        midi_mode: "MIDI 모드",
        light_show: "라이트 쇼",
        learning_mode: "러닝",
        light_show_help: "라이트 쇼: 피아노 건반이 LED를 켭니다. 컴퓨터 포트는 무시됩니다.",
        learning_mode_help: "러닝: 피아노 ↔ 컴퓨터 투명 연결. 가이드 라이트(채널 11/12 또는 velocity 1)가 LED를 켭니다. 노트는 양방향; 컴퓨터 컨트롤 변경은 차단할 수 있습니다.",
        suppress_computer_control: "컴퓨터에서 피아노로 가는 컨트롤 변경 차단",
        suppress_computer_control_help: "러닝 모드에서 control_change(리버브, 볼륨 등)가 피아노에 전달되지 않습니다. 노트와 가이드 라이트는 통과합니다.",
        piano_port_help: "라이트 쇼에서 건반을 밝히고 러닝에서 피아노로 노트를 재생하는 데 사용됩니다.",
        computer_port_help: "러닝 모드에서 Synthesia 등에 사용하는 RTP MIDI, USB-USB 또는 Bluetooth.",
        select_computer_port: "컴퓨터 포트 선택",
        piano_port_setup: "피아노 포트 설정",
        no_piano_port_message: "피아노 포트가 설정되지 않았습니다. 목록에서 피아노를 선택하세요.",
        playback_port: "재생 포트",
        input_port_setup: "입력 포트 설정",
        no_input_port_message: "현재 입력 포트가 설정되지 않았습니다. 아래 목록에서 피아노를 선택하세요.",
        port_will_be_set_both: "선택한 포트는 입력 포트와 재생 포트 모두로 설정됩니다.",
        select_piano_port: "피아노 포트 선택:",
        loading_ports: "포트 로드 중...",
        no_ports_available: "현재 사용 가능한 MIDI 포트가 없습니다. 피아노를 연결하고 페이지를 새로고침하세요.",
        dont_show_again: "이 메시지를 다시 표시하지 않음",
        set_port: "포트 설정",
        cancel: "취소",
        setting_port: "포트 설정 중...",
        select_port: "포트 선택...",
        error_loading_ports: "포트 로드 오류",
        no_ports: "사용 가능한 포트 없음",
    cover_state: "커버 상태",
    screen: "화면",
    lcd_type: "LCD 유형",
...
he: {
    ...
    //presets
    presets: "הגדרות מראש",
    select_preset: "בחר הגדרה מראש",
    load_preset: "טען",
    save_preset_button: "שמור",
    save_as_preset: "שמור בשם...",
    rename_preset_button: "שנה שם",
    delete_preset_button: "מחק",
    import_preset: "ייבא הגדרה מראש",
    export_preset: "ייצא הגדרה מראש",
    enter_preset_name: "הכנס שם הגדרה מראש:",
    preset_saved_successfully: "הגדרה מראש נשמרה בהצלחה",
    preset_error: "שגיאה: ",
    please_select_preset_to_save: "אנא בחר הגדרה מראש לשמירה",
    overwrite_preset_confirm: "האם לדרוס את ההגדרה מראש '{0}' עם ההגדרות הנוכחיות?",
    please_select_preset_first: "אנא בחר תחילה הגדרה מראש",
    load_preset_confirm: "האם לטעון את ההגדרה מראש '{0}'? זה יטען מחדש את הגדרות ה-LED (מצבי צבע, מצבי תאורה, בהירות).\n\nהערה: זה עלול לקחת 10+ שניות.",
    preset_load_timeout: "שגיאה: הבקשה פגה. ההגדרה מראש עדיין עשויה להיטען. אנא רענן את הדף.",
    preset_load_error: "שגיאה בטעינת הגדרה מראש: ",
    delete_preset_confirm: "האם למחוק את ההגדרה מראש '{0}'?",
    enter_new_preset_name: "הכנס שם חדש:",
    preset_uploaded_successfully: "הגדרה מראש הועלתה בהצלחה",
    ...
    search_songs: "חפש שירים...",
    no_songs_found: "לא נמצאו שירים",
    ...
    midi_events_filter: "סינון",
    midi_events_filter_all: "כל המכשירים",
    midi_events_filter_piano: "פסנתר",
    midi_events_filter_computer: "מחשב",
    clear_midi_events: "נקה",
    midi_events_copy_hint: "בחר טקסט ביומן כדי להעתיק. השורות מסומנות ב-[piano] או [computer].",
    ...
    hotspot_password_section_title: "סיסמת נקודת גישה",
    enter_hotspot_password: "הזן סיסמת נקודת גישה חדשה (לפחות 8 תווים)",
    change_hotspot_password_button: "שנה סיסמת נקודת גישה",
    show_password: "הצג סיסמה",
    hide_password: "הסתר סיסמה",
    password_too_short: "הסיסמה חייבת להכיל לפחות 8 תווים.",
    changing_hotspot_password_message: "משנה את סיסמת נקודת הגישה... אנא המתן.",
    hotspot_password_changed_success: "סיסמת נקודת הגישה שונתה בהצלחה! נקודת הגישה תופעל מחדש.",
    hotspot_password_changed_fail: "שינוי סיסמת נקודת הגישה נכשל.",
    hotspot_password_changed_fail_error: "שגיאה בשינוי סיסמת נקודת הגישה. נסה שוב.",
    hotspot_password_change_note: "הערה: שינוי הסיסמה יפעיל את נקודת הגישה אם אינה פעילה ויפעיל אותה מחדש, מה שינתק משתמשים מחוברים.",
    password_strength_weak: "חלשה",
    password_strength_medium: "בינונית",
    password_strength_strong: "חזקה",
    password_strength_very_strong: "חזקה מאוד",
    password_too_short_strength: "קצרה מדי",
    ...
    //idle schedule
    idle_schedule: "לוח זמנים של סרק",
    add_schedule: "הוסף לוח זמנים",
    schedule_enabled: "מופעל",
    schedule_disabled: "מושבת",
    schedule_delete: "מחק",
    schedule_no_schedules: "לא הוגדרו לוחות זמנים. אנימציית IDLE תרוץ בכל עת.",
    schedule_no_days: "אין ימים",
    schedule_form_not_found: "אלמנטי טופס לוח זמנים לא נמצאו",
    schedule_select_times: "אנא בחר גם זמן התחלה וגם זמן סיום",
    schedule_select_weekday: "אנא בחר לפחות יום אחד בשבוע",
    schedule_overlap_detected: "זיהוי חפיפת לוח זמנים ב",
    schedule_overlaps_with: "חופף עם",
    schedule_save_failed: "שמירת לוח זמנים נכשלה",
    schedule_network_error: "שגיאת רשת בשמירת לוח זמנים",
    schedule_day_mon: "ב'",
    schedule_day_tue: "ג'",
    schedule_day_wed: "ד'",
    schedule_day_thu: "ה'",
    ...
    settings: "הגדרות",
    practice_app_url: "כתובת ה-URL של אפליקציית התרגול",
    ...
    input_port: "פורט קלט",
    toggle_midi_mode: "החלף מצב",
    midi_mode_sidebar_light_show: "מצב: מופע אורות",
    midi_mode_sidebar_learning: "מצב: למידה",
    piano_port: "פורט פסנתר",
    computer_port: "פורט מחשב",
    midi_mode: "מצב MIDI",
    light_show: "מופע אורות",
    learning_mode: "למידה",
    light_show_help: "מופע אורות: מקשי הפסנתר מדליקים את ה-LED. פורט המחשב מתעלם.",
    learning_mode_help: "למידה: קישור שקוף בין פסנתר למחשב. אורות מנחים (ערוצים 11/12 או velocity 1) מדליקים את ה-LED. תווים עוברים לשני הכיוונים; ניתן לחסום control change מהמחשב.",
    suppress_computer_control: "חסום שינויי בקרה מהמחשב לפסנתר",
    suppress_computer_control_help: "במצב למידה עוצר הודעות control_change (ריוורב, עוצמה וכו') לפני שהן מגיעות לפסנתר. תווים ואורות מנחים ממשיכים לעבור.",
    piano_port_help: "משמש להדלקת מקשים במופע אורות ולהשמעה בפסנתר במצב למידה.",
    computer_port_help: "RTP MIDI, USB-USB או Bluetooth לשימוש עם Synthesia במצב למידה.",
    select_computer_port: "בחר פורט מחשב",
    piano_port_setup: "הגדרת פורט פסנתר",
    no_piano_port_message: "לא הוגדר פורט פסנתר. אנא בחר את הפסנתר מהרשימה.",
    playback_port: "פורט נגינה",
    input_port_setup: "הגדרת פורט קלט",
    no_input_port_message: "לא הוגדר פורט קלט כרגע. אנא בחר את הפסנתר שלך מהרשימה למטה.",
    port_will_be_set_both: "הפורט שנבחר יוגדר גם כפורט קלט וגם כפורט נגינה.",
    select_piano_port: "בחר פורט פסנתר:",
    loading_ports: "טוען פורטים...",
    no_ports_available: "אין פורטי MIDI זמינים כרגע. אנא חבר את הפסנתר שלך ורענן את הדף.",
    dont_show_again: "אל תציג הודעה זו שוב",
    set_port: "הגדר פורט",
    cancel: "ביטול",
    setting_port: "מגדיר פורט...",
    select_port: "בחר פורט...",
    error_loading_ports: "שגיאה בטעינת פורטים",
    no_ports: "אין פורטים זמינים",
    ...
    led_pin: "פין LED",
    led_pin_change_confirm: "שינוי פין ה-LED ל-{0} יפעיל מחדש את הוויזואלייזר. זה עשוי לקחת רגע. להמשיך?",
    led_pin_change_success: "פין ה-LED שונה. הוויזואלייזר מופעל מחדש. הדף יתרענן בקרוב.",
    led_pin_change_error: "שינוי פין ה-LED נכשל: {0}",
    ...
    mistakes: "שגיאה בזמן",
    max_acceptable_delay: "שהייה מקסימלית מותרת",
    time: "(שניות) MIDI זמן",
    delay: "שהייה (שניות)",
    reset_zoom:"איפוס",
...
ar:{
    ...
    load_preset: "تحميل",
    save_preset_button: "حفظ",
    save_as_preset: "حفظ باسم...",
    rename_preset_button: "إعادة تسمية",
    delete_preset_button: "حذف",
    import_preset: "استيراد إعداد مسبق",
    export_preset: "تصدير إعداد مسبق",
    enter_preset_name: "أدخل اسم الإعداد المسبق:",
    preset_saved_successfully: "تم حفظ الإعداد المسبق بنجاح",
    preset_error: "خطأ: ",
    please_select_preset_to_save: "يرجى اختيار إعداد مسبق للحفظ",
    overwrite_preset_confirm: "هل تريد استبدال الإعداد المسبق '{0}' بالإعدادات الحالية؟",
    please_select_preset_first: "يرجى اختيار إعداد مسبق أولاً",
    load_preset_confirm: "هل تريد تحميل الإعداد المسبق '{0}'؟ سيتم إعادة تحميل إعدادات LED (أوضاع الألوان، أوضاع الإضاءة، السطوع).\n\nملاحظة: قد يستغرق هذا 10+ ثوانٍ.",
    preset_load_timeout: "خطأ: انتهت مهلة الطلب. قد يكون الإعداد المسبق لا يزال قيد التحميل. يرجى تحديث الصفحة.",
    preset_load_error: "خطأ في تحميل الإعداد المسبق: ",
    delete_preset_confirm: "هل تريد حذف الإعداد المسبق '{0}'؟",
    enter_new_preset_name: "أدخل الاسم الجديد:",
    preset_uploaded_successfully: "تم تحميل الإعداد المسبق بنجاح",
    ...
    midi_events_filter: "تصفية",
    midi_events_filter_all: "كل الأجهزة",
    midi_events_filter_piano: "بيانو",
    midi_events_filter_computer: "كمبيوتر",
    clear_midi_events: "مسح",
    midi_events_copy_hint: "حدد النص في السجل لنسخه. الأسطر المعلّمة بـ [piano] أو [computer].",
    ...
    hotspot_password_section_title: "كلمة مرور نقطة الاتصال",
    enter_hotspot_password: "أدخل كلمة مرور نقطة الاتصال الجديدة (٨ أحرف على الأقل)",
    change_hotspot_password_button: "تغيير كلمة مرور نقطة الاتصال",
    show_password: "إظهار كلمة المرور",
    hide_password: "إخفاء كلمة المرور",
    password_too_short: "يجب أن تكون كلمة المرور ٨ أحرف على الأقل.",
    changing_hotspot_password_message: "جاري تغيير كلمة مرور نقطة الاتصال... يرجى الانتظار.",
    hotspot_password_changed_success: "تم تغيير كلمة مرور نقطة الاتصال بنجاح! سيتم إعادة تشغيل نقطة الاتصال.",
    hotspot_password_changed_fail: "فشل تغيير كلمة مرور نقطة الاتصال.",
    hotspot_password_changed_fail_error: "حدث خطأ أثناء تغيير كلمة مرور نقطة الاتصال. حاول مرة أخرى.",
    hotspot_password_change_note: "ملاحظة: تغيير كلمة المرور سيفعل نقطة الاتصال إن لم تكن نشطة ويعيد تشغيلها، مما يفصل المستخدمين الحاليين.",
    ...
    password_too_short_strength: "قصيرة جداً",
    ...
    //idle schedule
    idle_schedule: "جدول الخمول",
    add_schedule: "إضافة جدول",
    schedule_enabled: "مفعل",
    schedule_disabled: "معطل",
    schedule_delete: "حذف",
    schedule_no_schedules: "لا توجد جداول مُكوّنة. ستشغل حركة الخمول في أي وقت.",
    schedule_no_days: "لا توجد أيام",
    schedule_form_not_found: "عناصر نموذج الجدول غير موجودة",
    schedule_select_times: "يرجى تحديد وقتي البداية والنهاية",
    schedule_select_weekday: "يرجى تحديد يوم واحد على الأقل من أيام الأسبوع",
    schedule_overlap_detected: "تم اكتشاف تداخل في الجدول في",
    schedule_overlaps_with: "يتداخل مع",
    schedule_save_failed: "فشل حفظ الجدول",
    schedule_network_error: "خطأ في الشبكة أثناء حفظ الجدول",
    schedule_day_mon: "الاثنين",
    schedule_day_tue: "الثلاثاء",
    schedule_day_wed: "الأربعاء",
    schedule_day_thu: "الخميس",
    schedule_day_fri: "الجمعة",
    schedule_day_sat: "السبت",
    ...
    settings: "الإعدادات",
    practice_app_url: "رابط تطبيق التدريب",
    ...
    toggle_midi_mode: "تبديل الوضع",
    midi_mode_sidebar_light_show: "الوضع: عرض ضوئي",
    midi_mode_sidebar_learning: "الوضع: تعلم",
    piano_port: "منفذ البيانو",
    computer_port: "منفذ الكمبيوتر",
    midi_mode: "وضع MIDI",
    light_show: "عرض ضوئي",
    learning_mode: "تعلم",
    light_show_help: "العرض الضوئي: مفاتيح البيانو تضيء الـ LED. يتم تجاهل منفذ الكمبيوتر.",
    learning_mode_help: "التعلم: رابط شفاف بين البيانو والكمبيوتر. أضواء الإرشاد (القنوات 11/12 أو السرعة 1) تشغّل الـ LED. النغمات تمر بالاتجاهين؛ يمكن حظر control change من الكمبيوتر.",
    suppress_computer_control: "حظر تغييرات التحكم من الكمبيوتر إلى البيانو",
    suppress_computer_control_help: "في وضع التعلم، يمنع رسائل control_change (صدى، مستوى الصوت، إلخ) من الوصول إلى البيانو. النغمات وأضواء الإرشاد تمر كالمعتاد.",
    piano_port_help: "يُستخدم لإضاءة المفاتيح في العرض الضوئي ولتشغيل النغمات على البيانو في وضع التعلم.",
    computer_port_help: "RTP MIDI أو USB-USB أو Bluetooth لاستخدام Synthesia في وضع التعلم.",
    select_computer_port: "اختر منفذ الكمبيوتر",
    piano_port_setup: "إعداد منفذ البيانو",
    no_piano_port_message: "لم يتم تعيين منفذ بيانو. يرجى اختيار البيانو من القائمة.",
    playback_port: "منفذ التشغيل",
    input_port_setup: "إعداد منفذ الإدخال",
    no_input_port_message: "لم يتم تعيين منفذ إدخال حاليًا. يرجى اختيار البيانو من القائمة أدناه.",
    port_will_be_set_both: "سيتم تعيين المنفذ المحدد كمنفذ إدخال ومنفذ تشغيل.",
    select_piano_port: "اختر منفذ البيانو:",
    loading_ports: "جارٍ تحميل المنافذ...",
    no_ports_available: "لا توجد منافذ MIDI متاحة حاليًا. يرجى توصيل البيانو وتحديث الصفحة.",
    dont_show_again: "لا تظهر هذه الرسالة مرة أخرى",
    set_port: "تعيين المنفذ",
    cancel: "إلغاء",
    setting_port: "جارٍ تعيين المنفذ...",
    select_port: "اختر منفذًا...",
    error_loading_ports: "خطأ في تحميل المنافذ",
    no_ports: "لا توجد منافذ متاحة",
    ...
    led_pin: "دبوس LED",
    led_pin_change_confirm: "تغيير دبوس LED إلى {0} سيعيد تشغيل العارض. قد يستغرق هذا لحظة. المتابعة؟",
    led_pin_change_success: "تم تغيير دبوس LED. جاري إعادة تشغيل العارض. ستُحدَّث الصفحة قريباً.",
    led_pin_change_error: "فشل تغيير دبوس LED: {0}",
    ...
    max_acceptable_delay: "أقصى تأخير مسموح",
