...
const translations = {
    en: {
        ...
        per_strip_hint: "Brightness, Reverse, Shift, Led Count and Leds per meter apply to the selected strip. Colors, light mode, backlight, gamma and note offsets are shared by both strips.",
    ...
    pl: {
        ...
        second_strip_pin: "Pin",
        per_strip_hint: "Jasność, Odwrócenie, Przesunięcie, Liczba diod i Diody na metr dotyczą wybranego paska. Kolory, tryb świecenia, podświetlenie, gamma i przesunięcia nut są wspólne dla obu pasków.",
